...
create_project $proj_name $script_dir/$proj_name -part xczu7ev-ffvc1156-2-e -force
create_bd_design $bd_name
set bd_path [get_files $bd_name\.bd]
set_property  ip_repo_paths  $script_dir/$bd_name/ZCU104/impl [current_project]
update_ip_catalog
...
#open_run impl_1
#report_utilization -file $script_dir/Vivado_Utilization.rpt -hierarchical
#report_timing_summary -file $script_dir/Vivado_Timing.rpt
exit
