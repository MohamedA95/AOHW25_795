...
{{
	...
	act_json << sdwc_7.get_json_string("sdwc_7") << "," << std::endl;
	act_json << Concat_0.get_json_string("Concat_0") << "," << std::endl;
	act_json << sdwc_8.get_json_string("sdwc_8") << "," << std::endl;
	act_json << Conv_layer_6.get_json_string("Conv_layer_6") << "," << std::endl;
	act_json << Conv_layer_7.get_json_string("Conv_layer_7") << "," << std::endl;
	act_json << sdwc_9.get_json_string("sdwc_9") << "," << std::endl;
	act_json << ConvTranspose_1.get_json_string("ConvTranspose_1") << "," << std::endl;
	act_json << sdwc_10.get_json_string("sdwc_10") << "," << std::endl;
	act_json << Concat_1.get_json_string("Concat_1") << "," << std::endl;
	act_json << sdwc_11.get_json_string("sdwc_11") << "," << std::endl;
	act_json << Conv_layer_8.get_json_string("Conv_layer_8") << "," << std::endl;
	act_json << Conv_layer_9.get_json_string("Conv_layer_9") << "," << std::endl;
	act_json << sdwc_12.get_json_string("sdwc_12") << "," << std::endl;
	act_json << Conv_layer_10.get_json_string("Conv_layer_10") << std::endl;
	act_json << "]" << std::endl;
	act_json.close();
}}
