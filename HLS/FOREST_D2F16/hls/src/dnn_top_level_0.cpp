...
#pragma HLS STREAM variable=conv_layer_0_m2s depth=64
	hls::stream<ap_uint<CONV_LAYER_0_INPUT_STREAM_WIDTH>> conv_layer_0_input_stream;
#pragma HLS STREAM variable=conv_layer_0_input_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_0_OUTPUT_STREAM_WIDTH>> conv_layer_0_sdwc_0_stream;
#pragma HLS STREAM variable=conv_layer_0_sdwc_0_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_1_INPUT_STREAM_WIDTH>> sdwc_0_conv_layer_1_stream;
#pragma HLS STREAM variable=sdwc_0_conv_layer_1_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_1_OUTPUT_STREAM_WIDTH>> conv_layer_1_sdwc_1_stream;
#pragma HLS STREAM variable=conv_layer_1_sdwc_1_stream depth=64
	hls::stream<ap_uint<SPLIT_0_INPUT_STREAM_WIDTH>> sdwc_1_split_0_stream;
#pragma HLS STREAM variable=sdwc_1_split_0_stream depth=64
	hls::stream<ap_uint<MAXPOOL_0_INPUT_STREAM_WIDTH>> split_0_maxpool_0_stream;
#pragma HLS STREAM variable=split_0_maxpool_0_stream depth=64
	hls::stream<ap_uint<MAXPOOL_0_OUTPUT_STREAM_WIDTH>> maxpool_0_sdwc_2_stream;
#pragma HLS STREAM variable=maxpool_0_sdwc_2_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_2_INPUT_STREAM_WIDTH>> sdwc_2_conv_layer_2_stream;
#pragma HLS STREAM variable=sdwc_2_conv_layer_2_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_2_OUTPUT_STREAM_WIDTH>> conv_layer_2_sdwc_3_stream;
#pragma HLS STREAM variable=conv_layer_2_sdwc_3_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_3_INPUT_STREAM_WIDTH>> sdwc_3_conv_layer_3_stream;
#pragma HLS STREAM variable=sdwc_3_conv_layer_3_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_3_OUTPUT_STREAM_WIDTH>> conv_layer_3_sdwc_4_stream;
#pragma HLS STREAM variable=conv_layer_3_sdwc_4_stream depth=64
	hls::stream<ap_uint<SPLIT_1_INPUT_STREAM_WIDTH>> sdwc_4_split_1_stream;
#pragma HLS STREAM variable=sdwc_4_split_1_stream depth=64
	hls::stream<ap_uint<MAXPOOL_1_INPUT_STREAM_WIDTH>> split_1_maxpool_1_stream;
#pragma HLS STREAM variable=split_1_maxpool_1_stream depth=64
	hls::stream<ap_uint<MAXPOOL_1_OUTPUT_STREAM_WIDTH>> maxpool_1_sdwc_5_stream;
#pragma HLS STREAM variable=maxpool_1_sdwc_5_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_4_INPUT_STREAM_WIDTH>> sdwc_5_conv_layer_4_stream;
#pragma HLS STREAM variable=sdwc_5_conv_layer_4_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_5_INPUT_STREAM_WIDTH>> conv_layer_4_conv_layer_5_stream;
#pragma HLS STREAM variable=conv_layer_4_conv_layer_5_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_5_OUTPUT_STREAM_WIDTH>> conv_layer_5_sdwc_6_stream;
#pragma HLS STREAM variable=conv_layer_5_sdwc_6_stream depth=64
	hls::stream<ap_uint<CONVTRANSPOSE_0_INPUT_STREAM_WIDTH>> sdwc_6_convtranspose_0_stream;
#pragma HLS STREAM variable=sdwc_6_convtranspose_0_stream depth=64
	hls::stream<ap_uint<CONCAT_0_INPUT_STREAM_WIDTH>> split_1_concat_0_stream;
#pragma HLS STREAM variable=split_1_concat_0_stream depth=59046
	hls::stream<ap_uint<CONCAT_0_INPUT_STREAM_WIDTH>> convtranspose_0_concat_0_stream;
#pragma HLS STREAM variable=convtranspose_0_concat_0_stream depth=64
	hls::stream<ap_uint<CONCAT_0_OUTPUT_STREAM_WIDTH>> concat_0_sdwc_7_stream;
#pragma HLS STREAM variable=concat_0_sdwc_7_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_6_INPUT_STREAM_WIDTH>> sdwc_7_conv_layer_6_stream;
#pragma HLS STREAM variable=sdwc_7_conv_layer_6_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_6_OUTPUT_STREAM_WIDTH>> conv_layer_6_sdwc_8_stream;
#pragma HLS STREAM variable=conv_layer_6_sdwc_8_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_7_INPUT_STREAM_WIDTH>> sdwc_8_conv_layer_7_stream;
#pragma HLS STREAM variable=sdwc_8_conv_layer_7_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_7_OUTPUT_STREAM_WIDTH>> conv_layer_7_sdwc_9_stream;
#pragma HLS STREAM variable=conv_layer_7_sdwc_9_stream depth=64
	hls::stream<ap_uint<CONVTRANSPOSE_1_INPUT_STREAM_WIDTH>> sdwc_9_convtranspose_1_stream;
#pragma HLS STREAM variable=sdwc_9_convtranspose_1_stream depth=64
	hls::stream<ap_uint<CONCAT_1_INPUT_STREAM_WIDTH>> split_0_concat_1_stream;
#pragma HLS STREAM variable=split_0_concat_1_stream depth=118028
	hls::stream<ap_uint<CONCAT_1_INPUT_STREAM_WIDTH>> convtranspose_1_concat_1_stream;
#pragma HLS STREAM variable=convtranspose_1_concat_1_stream depth=64
	hls::stream<ap_uint<CONCAT_1_OUTPUT_STREAM_WIDTH>> concat_1_sdwc_10_stream;
#pragma HLS STREAM variable=concat_1_sdwc_10_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_8_INPUT_STREAM_WIDTH>> sdwc_10_conv_layer_8_stream;
#pragma HLS STREAM variable=sdwc_10_conv_layer_8_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_9_INPUT_STREAM_WIDTH>> conv_layer_8_conv_layer_9_stream;
#pragma HLS STREAM variable=conv_layer_8_conv_layer_9_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_9_OUTPUT_STREAM_WIDTH>> conv_layer_9_sdwc_11_stream;
#pragma HLS STREAM variable=conv_layer_9_sdwc_11_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_10_INPUT_STREAM_WIDTH>> sdwc_11_conv_layer_10_stream;
#pragma HLS STREAM variable=sdwc_11_conv_layer_10_stream depth=64
	hls::stream<ap_uint<CONV_LAYER_10_OUTPUT_STREAM_WIDTH>> conv_layer_10_output_stream;
#pragma HLS STREAM variable=conv_layer_10_output_stream depth=64
	hls::stream<ap_uint<OUTPUT_MEM_WIDTH>> conv_layer_10_s2m;
#pragma HLS STREAM variable=conv_layer_10_s2m depth=64
	...
	StreamingDataWidthConverter_Batch<CONV_LAYER_0_OUTPUT_STREAM_WIDTH, CONV_LAYER_1_INPUT_STREAM_WIDTH, CONV_LAYER_0_OUTPUT_ACCESSES>(conv_layer_0_sdwc_0_stream,  sdwc_0_conv_layer_1_stream, Reps);
	...
	>
	(sdwc_0_conv_layer_1_stream,
	conv_layer_1_sdwc_1_stream,
	...
	StreamingDataWidthConverter_Batch<CONV_LAYER_1_OUTPUT_STREAM_WIDTH, MAXPOOL_0_INPUT_STREAM_WIDTH, CONV_LAYER_1_OUTPUT_ACCESSES>(conv_layer_1_sdwc_1_stream,  sdwc_1_split_0_stream, Reps);
	...
	>
	(split_0_maxpool_0_stream,
	maxpool_0_sdwc_2_stream,
	Reps);

	std::cout << "sdwc_2" << std::endl;

	StreamingDataWidthConverter_Batch<MAXPOOL_0_OUTPUT_STREAM_WIDTH, CONV_LAYER_2_INPUT_STREAM_WIDTH, MAXPOOL_0_OUTPUT_ACCESSES>(maxpool_0_sdwc_2_stream,  sdwc_2_conv_layer_2_stream, Reps);
	...
	>
	(sdwc_2_conv_layer_2_stream,
	conv_layer_2_sdwc_3_stream,
	...
	StreamingDataWidthConverter_Batch<CONV_LAYER_2_OUTPUT_STREAM_WIDTH, CONV_LAYER_3_INPUT_STREAM_WIDTH, CONV_LAYER_2_OUTPUT_ACCESSES>(conv_layer_2_sdwc_3_stream,  sdwc_3_conv_layer_3_stream, Reps);
	...
	>
	(sdwc_3_conv_layer_3_stream,
	conv_layer_3_sdwc_4_stream,
	...
	StreamingDataWidthConverter_Batch<CONV_LAYER_3_OUTPUT_STREAM_WIDTH, MAXPOOL_1_INPUT_STREAM_WIDTH, CONV_LAYER_3_OUTPUT_ACCESSES>(conv_layer_3_sdwc_4_stream,  sdwc_4_split_1_stream, Reps);
	...
	>
	(split_1_maxpool_1_stream,
	maxpool_1_sdwc_5_stream,
	Reps);

	std::cout << "sdwc_5" << std::endl;

	StreamingDataWidthConverter_Batch<MAXPOOL_1_OUTPUT_STREAM_WIDTH, CONV_LAYER_4_INPUT_STREAM_WIDTH, MAXPOOL_1_OUTPUT_ACCESSES>(maxpool_1_sdwc_5_stream,  sdwc_5_conv_layer_4_stream, Reps);
	...
	>
	(sdwc_5_conv_layer_4_stream,
	conv_layer_4_conv_layer_5_stream,
	...
	convtranspose_0_concat_0_stream,
	...
	StreamingDataWidthConverter_Batch<CONCAT_0_OUTPUT_STREAM_WIDTH, CONV_LAYER_6_INPUT_STREAM_WIDTH, CONCAT_0_OUTPUT_ACCESSES>(concat_0_sdwc_7_stream,  sdwc_7_conv_layer_6_stream, Reps);
	...
	>
	(sdwc_7_conv_layer_6_stream,
	conv_layer_6_sdwc_8_stream,
	...
	StreamingDataWidthConverter_Batch<CONV_LAYER_6_OUTPUT_STREAM_WIDTH, CONV_LAYER_7_INPUT_STREAM_WIDTH, CONV_LAYER_6_OUTPUT_ACCESSES>(conv_layer_6_sdwc_8_stream,  sdwc_8_conv_layer_7_stream, Reps);
	...
	convtranspose_1_concat_1_stream,
	...
	StreamingDataWidthConverter_Batch<CONCAT_1_OUTPUT_STREAM_WIDTH, CONV_LAYER_8_INPUT_STREAM_WIDTH, CONCAT_1_OUTPUT_ACCESSES>(concat_1_sdwc_10_stream,  sdwc_10_conv_layer_8_stream, Reps);
	...
	StreamingDataWidthConverter_Batch<CONV_LAYER_9_OUTPUT_STREAM_WIDTH, CONV_LAYER_10_INPUT_STREAM_WIDTH, CONV_LAYER_9_OUTPUT_ACCESSES>(conv_layer_9_sdwc_11_stream,  sdwc_11_conv_layer_10_stream, Reps);
